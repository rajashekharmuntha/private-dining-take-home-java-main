...
* [ADR 0001: Concurrency Control Strategy](./docs/adr/0001-concurrency-control-strategy.md) - Focuses on Optimistic Locking and Spring Retry.
* [ADR 0002: Idempotency and Duplicate Detection](./docs/adr/0002-idempotency-and-duplicate-detection.md) - Explains the Compound Unique Index strategy.
* [ADR 0003: Persistence Technology Choice](./docs/adr/0003-persistence-technology-choice.md) - Justifies the use of MongoDB and the Document Model.
* [ADR 0004: Hierarchical Configuration](./docs/adr/0004-hierarchical-configuration.md) - Details the cascading fallback logic for business rules.
